...
@WebServlet(name = "searchProjectDevServlet", value = "/search_project_dev")
public class SearchProjectDevServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        HashMap<Projet, User> matchingProjects = gestionProjets.mapProjectsNameToDev(valueSearch,email);
        ...
        if (matchingProjects != null) {
            for (Map.Entry<Projet, User> entry : matchingProjects.entrySet()) {
                ...
                htmlResponse.append("<a href=\"DetailProjectDev?projectId=").append(currentProjet.getId()).append("\" > <img src=\"resources/images/img.png\" alt=\"\" width=\"25px\" height=\"25px\" style=\"margin-left: 20px;\"> </a>");
